...
if ( jQuery && typeof jQuery !== 'undefined' ) {
  jQuery.fn.customSlider = function( config ) {
    var errExtraMsg = ' Please consult the documentation for more information: https://design.dwebs.io/docs';

    if ( typeof config === 'undefined' ) {
      throw new Error('dWeb Design Kit\'s custom slider component requires a configuration object.' + errExtraMsg);
    }
    ...
    requiredConfigProps.map(function(requiredProp) {
      if ( typeof config[requiredProp.prop] === 'undefined' ) {
        throw new Error('dWeb Design Kit\'s custom slider component requires a `' + requiredProp.prop + '` property passed in the configuration object. For example: `' + requiredProp.example + '`' + errExtraMsg);
      }
    });
